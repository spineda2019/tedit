...
/// TODO(SEP): Docs
template <libzig::meta::fs::FileHandleType T>
    requires(T == libzig::meta::fs::FileHandleType::FileDescriptor)
file_handle_t GetSpecialFileHandleHelper(
    libzig::meta::fs::SpecialFile sf) noexcept {
    switch (sf) {
...
template <libzig::meta::fs::FileHandleType T>
    requires(T == libzig::meta::fs::FileHandleType::Handle)
file_handle_t GetSpecialFileHandleHelper(
    libzig::meta::fs::SpecialFile) noexcept {
    static_assert(false, "TODO: Windows not yet supported");
}
}  // namespace detail

// defined in TU
file_handle_t GetSpecialFileHandle(libzig::meta::fs::SpecialFile) noexcept;
